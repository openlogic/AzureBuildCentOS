# Kickstart for provisioning a CentOS 8.0 Azure VM for Azure China
...
sed -i 's/mirror.centos.org/olcentchan.chinacloudapp.cn/'  /etc/yum.repos.d/CentOS-AppStream.repo
...
sed -i 's/mirror.centos.org/olcentchan.chinacloudapp.cn/'  /etc/yum.repos.d/CentOS-Base.repo
