# Kickstart for provisioning a RHEL 6.8 Azure Stack VM
...
curl -so /root/WALinuxAgent-2.1.6-1.el6.noarch.rpm https://raw.githubusercontent.com/szarkos/AzureBuildCentOS/master/rpm/6/WALinuxAgent-2.1.6-1.el6.noarch.rpm
rpm -i /root/WALinuxAgent-2.1.6-1.el6.noarch.rpm
rm -f /root/WALinuxAgent-2.1.6-1.el6.noarch.rpm
