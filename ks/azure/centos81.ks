# Kickstart for provisioning a CentOS 8.1 Azure VM
...
#sed -i -e 's/$releasever/8.1.1911/g' /etc/yum.repos.d/*CentOS*.repo
...
#sed -i -e 's/8.1.1911/$releasever/g' /etc/yum.repos.d/*CentOS*.repo
