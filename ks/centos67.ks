...
# Add OpenLogic repo
repo --name=openlogic --baseurl=http://olcentgbl.trafficmanager.net/openlogic/6.7/openlogic/x86_64/
...
sed -i 's/ numa=off//g' /boot/grub/menu.lst
sed -i 's/ rhgb//g' /boot/grub/menu.lst
sed -i 's/ quiet//g' /boot/grub/menu.lst
sed -i 's/ crashkernel=auto//g' /boot/grub/menu.lst
